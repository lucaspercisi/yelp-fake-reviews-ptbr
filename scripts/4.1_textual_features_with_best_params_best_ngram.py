...
for vect_name, classifier_dict in {'TF-IDF': classifiers_tfidf, 'BoW': classifiers_bow}.items():
    for clf_name, classifier in classifier_dict.items():
        ...
        # Adicionando ao CSV
        adicionar_ao_csv({'Vetorizador': vect_name, 'Classificador': clf_name, 'F1 Score': media_score}, caminho_base, vect_name, clf_name)
...
for clf_name, classifier in classifiers_word2vec.items():
    ...
    # Adicionando ao CSV
    adicionar_ao_csv({'Vetorizador': 'Word2Vec', 'Classificador': clf_name, 'F1 Score': media_score}, caminho_base, 'Word2Vec', clf_name)